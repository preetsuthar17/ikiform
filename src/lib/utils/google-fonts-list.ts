...
export const GOOGLE_FONTS_DATA: GoogleFont[] = [
  ...
  { family: "Roboto", category: "Sans Serif", variants: ["300", "400", "500", "700"], subsets: ["latin"] },
  { family: "Open Sans", category: "Sans Serif", variants: ["400", "600", "700"], subsets: ["latin"] },
  ...
  { family: "Work Sans", category: "Sans Serif", variants: ["400", "500", "600"], subsets: ["latin"] },
  ...
  { family: "Crimson Text", category: "Serif", variants: ["400", "600"], subsets: ["latin"] },
  { family: "EB Garamond", category: "Serif", variants: ["400", "500", "600"], subsets: ["latin"] },
  { family: "Spectral", category: "Serif", variants: ["400", "500", "600"], subsets: ["latin"] },
  { family: "IBM Plex Serif", category: "Serif", variants: ["400", "500", "600"], subsets: ["latin"] },
  { family: "Literata", category: "Serif", variants: ["400", "500", "600"], subsets: ["latin"] },
  
  // Display
  { family: "Bebas Neue", category: "Display", variants: ["400"], subsets: ["latin"] },
  { family: "Oswald", category: "Display", variants: ["400", "500", "600"], subsets: ["latin"] },
  { family: "Righteous", category: "Display", variants: ["400"], subsets: ["latin"] },
  { family: "Lobster", category: "Display", variants: ["400"], subsets: ["latin"] },
  { family: "Dancing Script", category: "Display", variants: ["400", "700"], subsets: ["latin"] },
  { family: "Caveat", category: "Display", variants: ["400", "700"], subsets: ["latin"] },
  { family: "Amatic SC", category: "Display", variants: ["400", "700"], subsets: ["latin"] },
  
  // Monospace
  { family: "Fira Code", category: "Monospace", variants: ["400", "500", "700"], subsets: ["latin"] },
  { family: "JetBrains Mono", category: "Monospace", variants: ["400", "500", "700"], subsets: ["latin"] },
  { family: "Source Code Pro", category: "Monospace", variants: ["400", "500", "600"], subsets: ["latin"] },
  { family: "IBM Plex Mono", category: "Monospace", variants: ["400", "500", "600"], subsets: ["latin"] },
  { family: "Roboto Mono", category: "Monospace", variants: ["400", "500"], subsets: ["latin"] },
];

export function getFontsByCategory(category: keyof typeof GOOGLE_FONTS_CATEGORIES) {
