      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-18">
        {features.map((feature, idx) => (
          ...
          >
            ...
            <div
              className={
                'flex aspect-video w-full items-center justify-center overflow-hidden rounded-card bg-gradient-to-b p-4 shadow-[inset_0px_-24px_66px_-11px_hsl(var(--hu-home-card-bg),0.1)] md:p-12'
              }
              style={{
                position: 'relative',
              }}
