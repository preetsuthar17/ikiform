...
const breadcrumbLinkVariants = cva(
  "transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-ele flex items-center gap-1",
  {
    variants: {},
    defaultVariants: {},
  }
