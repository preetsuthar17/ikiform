      ...
      <div className="relative">
        ...
        {clearAllButton && safeTags.length > 0 && (
          <button
            ...
            disabled={disabled}
            className="absolute right-2 top-1/2 -translate-y-1/2 rounded-card p-1 hover:bg-accent transition-colors disabled:pointer-events-none disabled:opacity-50"
