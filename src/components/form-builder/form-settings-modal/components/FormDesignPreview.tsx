...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select-base";
...
export function FormDesignPreview({
  ...
  React.useEffect(() => {
    ...
    style.textContent = `
      .form-preview-container {
        ...
        overflow: hidden;
        ${!isMinimal ? `border: 1px solid ${borderColor} !important;` : 'border: none !important;'}
  ...
  }, [formBorderRadius, colors.border, colors.primary, typography.fontSize, typography.fontWeight, typography.fontFamily]);
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm opacity-80">
              This is how your form will appear with the current design settings.
            </p>
          </div>
          <Separator/>
          {/* Sample Fields */}
