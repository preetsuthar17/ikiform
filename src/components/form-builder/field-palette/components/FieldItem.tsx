...
export function FieldItem({ fieldType, onAddField }: FieldItemProps) {
  ...
  return (
    <Card
      className="group bg-background border-border hover:border-ring/20 transition-all duration-200 cursor-pointer hover:shadow-md/2"
      onClick={() => onAddField(fieldType.type)}
    >
      <div className="flex items-center gap-3 p-3">
        <div className="flex-shrink-0 bg-accent rounded-lg group-hover:bg-primary/10 transition-colors duration-200 flex items-center justify-center">
