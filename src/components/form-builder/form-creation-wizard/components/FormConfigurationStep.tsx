  ...
  <div className="flex flex-col gap-6">
    <Card className="shadow-none">
      <CardHeader className="[.border-b]:border-border">
        ...
        <CardDescription>Set the internal and public information for your form.</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <Label htmlFor="form-title">Internal Title <span aria-hidden>*</span></Label>
            <Input
              ...
              inputMode="text"
              name="internal-title"
              onBlur={(e) => onConfigurationChange({ title: e.target.value.trim() })}
            ...
            />
            <p id="form-title-help" className="text-muted-foreground text-xs">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              inputMode="text"
              name="public-title"
              onBlur={(e) => onConfigurationChange({ publicTitle: e.target.value.trim() })}
              onChange={(e) =>
            ...
            />
            <p id="form-public-title-help" className="text-muted-foreground text-xs">
              Shown to users on the form. Leave empty to reuse the internal title.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Textarea
              ...
              onBlur={(e) => onConfigurationChange({ description: e.target.value.trim() })}
              onChange={(e) =>
            ...
            />
            <p id="form-description-help" className="text-muted-foreground text-xs">
