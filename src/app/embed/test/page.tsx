      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="gradient-bg flex h-16 w-16 items-center justify-center rounded-card mx-auto mb-6">
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="border-2 border-dashed border-border/50 p-4 rounded-ele bg-accent/5">
                  <iframe
            ...
            <Card>
              ...
              <CardContent>
                <div className="border-2 border-dashed border-border/50 p-4 rounded-ele bg-accent/5 flex justify-center">
                  <iframe
                    src={`/forms/${sampleFormId}`}
                    width="800px"
                    height="500px"
