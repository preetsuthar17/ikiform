...
import { Check, Copy, Code2, Globe, FileText, Shield, Zap, X } from 'lucide-react';
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium">{embedModes.find(m => m.id === embedMode)?.name} Code</span>
              <Button
