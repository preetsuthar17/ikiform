...
export default function EmbedCodeGenerator({ config, embedUrl, formId }: EmbedCodeGeneratorProps) {
  ...
  const embedModes = [
    { id: 'html', name: 'HTML', icon: Globe, description: 'Universal HTML iframe' },
    { id: 'react', name: 'React', icon: Code2, description: 'React component' },
    { id: 'nextjs', name: 'Next.js', icon: Code2, description: 'Next.js component' },
    { id: 'vue', name: 'Vue', icon: Code2, description: 'Vue.js component' },
    { id: 'wordpress', name: 'WordPress', icon: FileText, description: 'WordPress shortcode' },
  ];

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-foreground">Get Embed Code</h3>
        <Button
      ...
      <Card className="bg-accent/5">
        ...
        <CardContent>
          ...
          {embedMode === 'html' && (
            <p>Copy the HTML code and paste it directly into your website where you want the form to appear.</p>
          )}
          {embedMode === 'react' && (
            <div>
              <p>1. Copy the React component code</p>
              <p>2. Save it as a new component file (e.g., EmbeddedForm.jsx)</p>
          ...
          {embedMode === 'nextjs' && (
            <div>
              ...
              <p>4. The component includes TypeScript types for better development experience</p>
            </div>
          )}
          {embedMode === 'vue' && (
            <div>
          ...
          {embedMode === 'wordpress' && (
            <div>
              ...
              <p>2. Or paste the HTML code in a Custom HTML block in the block editor</p>
              <p>3. The shortcode requires the IkiForm WordPress plugin (coming soon)</p>
            </div>
          )}
          </div>
        </CardContent>
